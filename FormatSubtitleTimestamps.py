...
def main():
    ...
    user_input = input(
        'Enter the full path of a YouTube transcript file in .txt format ("" in path will be removed automatically): '
    ).strip()
    ...
    print("Formatted subtitle file has been saved to", output_path)
